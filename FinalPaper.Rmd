...
Then using a Monte Carlo simulation, we simulate the match we are interested in (Aston Villa - Arsenal), and the remainder of the season following our match of interest. In order to further analyze the match, and analyze its importance, we kept track of the outcome of each simulation of our game of interest, and whether or not Aston Villa was relegated or not at the end of each simulated season. A contingency table of Aston Villa's resulst in each simulated game versus Arsenal, along with the associated season outcome of each results is shown below.
...
cont_table <- data.frame("Result" = c("@in", "Tie", "Loss", "Sum"),
